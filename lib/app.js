...
function startApp() {
  ...
  function showHelp() {
    const helpText = [
      ...
      "   {bold}n{/bold} - Create a new todo",
      "   {bold}d{/bold} - Delete the selected todo",
      "   {bold}e{/bold} - Edit the selected todo",
      "   {bold}space{/bold} - Toggle completion of the selected todo",
      "   {bold}!{/bold} - Toggle priority of the selected todo",
